<?php
/**
 * Template Name: Recent Comment Links
 *
 * Used for displaying links to the N most recent comments. 
 */
...
get_header(); ?>
		...
		<div id="primary" class="site-content">
			<div id="content" role="main">
				...
				<h1 class="entry-title">Links to the most recent <?= $n ?> comments</h1>
				<p>
				...
				<div id="comments" class="comments-area">
					<ol class="commentlist">
						<?php
							 ...
							 */
							wp_list_comments( array( 'callback' => 'ml_comment_recent_comment_links' ), $comments );
						?>
					</ol>
				</div>
